...
#支付宝接口配置
$codepay_config['id'] = $conf['epay_id'];
$codepay_config['key'] = $conf['epay_key'];
...
$codepay_config['path'] = $codepay_config['domain'] . dirname($_SERVER['REQUEST_URI']); //API安装路径 最终为http://域名/codepay

if ((int)$codepay_config['id'] < 1) exit('请先到后台配置ID跟密钥');
