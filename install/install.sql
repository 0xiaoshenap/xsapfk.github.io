...
INSERT INTO `ayangw_config` VALUES ('sqlv','1041'),('title','个人发卡网'),('keywords','个人发卡网,pay.c7e.cn'),('description','欢迎使用'),('zzqq','12345'),('notice2','付款后按提示点击确定跳转到提取页面，不可提前关闭窗口！否则无法提取到卡密！'),('notice3','提取码是订单编号 或者 您的联系方式！'),('notice1','提取卡密后请尽快激活使用或保存好，系统定期清除被提取的卡密'),('foot','全名发卡网演示站'),('dd_notice','1.联系方式也可以作为你的提卡凭证<br>2.必须等待付款完成自动跳转，不可提前关闭页面，否则会导致订单失效，后果自负'),('admin','admin'),('pwd','f3b4e3b975e0484835e90514f8318e61'),('web_url','localhost'),('payapi','9'),('epay_id','1000'),('epay_key','K6Lyk040y46n0lkyMK0kbBVKFLy0fkfB'),('showKc','1'),('CC_Defender','2'),('txprotect','1'),('qqtz','1'),('create','2018-07-15 13:31:59'),('view','zongzi'),('submit','修改'),('epay_url','https://pay.xiaobaibk.cn/'),('showImgs','1'),('cyapi','1'),('cyid',''),('cykey',''),('cygg',''),('syslog','1');
...
INSERT INTO `if_config` VALUES ('title','个人发卡网'),('keywords','个人发卡网'),('description','个人发卡网'),('zzqq','123456'),('notice2','付款后按提示点击确定跳转到提取页面，不可提前关闭窗口！否则无法提取到卡密！'),('notice3','提取码是订单编号 或者 您的联系方式！'),('notice1','提取卡密后请尽快激活使用或保存好，系统定期清除被提取的卡密'),('foot','个人发卡网'),('dd_notice','1.联系方式也可以作为你的提卡凭证<br>2.必须等待付款完成自动跳转，不可提前关闭页面，否则会导致订单失效，后果自负'),('admin','admin'),('pwd','f3b4e3b975e0484835e90514f8318e61'),('web_url','127.0.0.1'),('payapi','4'),('epay_id','123456'),('epay_key','123456'),('showKc','1'),('CC_Defender','2'),('txprotect','1'),('qqtz','2'),('sqlv','1041'),('epay_url','https://pay.xiaobaibk.cn/'),('create','2018-07-15 18:32:58'),('view','zongzi'),('submit','修改'),('showImgs','1'),('cyapi','1'),('cyid',''),('cykey',''),('cygg',''),('syslog','1');
